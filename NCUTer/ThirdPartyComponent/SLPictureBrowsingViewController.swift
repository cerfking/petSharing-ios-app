...
class SLPictureBrowsingViewController: UIViewController {
    ...
    var fromViewController: HomeViewController? //界面来源
    var fromViewController2: CertainUserViewController?
    var fromViewController3: CertainPostViewController?
    ...
    func previousAnimatonView() -> UIView {
        if fromViewController != nil {
        ...
        else if fromViewController2 != nil{
            let tableViewCell: SLTableViewCell = fromViewController2!.tableView.cellForRow(at: currentIndexPath) as! SLTableViewCell
            if animatonSource == SLAnimatonSource.Atlas {
                //图集浏览
                let imageView: AnimatedImageView = tableViewCell.picsArray[currentPage]
                let tempView: AnimatedImageView = AnimatedImageView()
            ...
            let tableViewCell: SLTableViewCell = fromViewController3!.tableView.cellForRow(at: currentIndexPath) as! SLTableViewCell
            if animatonSource == SLAnimatonSource.Atlas {
                //图集浏览
                let imageView: AnimatedImageView = tableViewCell.picsArray[currentPage]
                let tempView: AnimatedImageView = AnimatedImageView()
...
extension SLPictureBrowsingViewController : UIViewControllerTransitioningDelegate {
    ...
    func animationController(forPresented presented: UIViewController, presenting: UIViewController, source: UIViewController) -> UIViewControllerAnimatedTransitioning? {
        fromViewController = source as? HomeViewController
        fromViewController2 = source as? CertainUserViewController
        fromViewController3 = source as? CertainPostViewController

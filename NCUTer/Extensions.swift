...
extension UITextField {
    func setLeftView(image: UIImage,tintColor:UIColor?) {
    let iconView = UIImageView(frame: CGRect(x: 15, y: 10, width: 25, height: 25)) // set your Own size
    iconView.image = image
    let iconContainerView: UIView = UIView(frame: CGRect(x: 0, y: 0, width: 50, height: 45))

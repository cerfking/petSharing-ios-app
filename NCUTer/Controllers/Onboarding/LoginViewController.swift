...
class LoginViewController: UIViewController {
    ...
    private let headerView:UIImageView = {
        ...
        headerView.image = UIImage(named: "petco-logo")
        return headerView
    }()
    ...
    override func viewDidLayoutSubviews() {
        ...
        button.frame = CGRect(
            ...
            width: view.width - 50,
            height: 52.0)
        loginWithMobileNumberButton.frame = CGRect(
            x: 10,
            y: 750,
        ...
        AuthManager.shared.loginWithUsername(username: usernameEmail, password: password){ [weak self]
            ...
            DispatchQueue.main.async {
                if success{
                    ...
                    let failAlert = UIAlertController(title: "登录失败", message: "账号或密码错误，请重新输入", preferredStyle: .alert)
